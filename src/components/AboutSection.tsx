      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-moss-600 max-w-4xl mx-auto leading-relaxed">
              Почему стабилизированный мох и цетрария — идеальное решение для
              современных интерьеров, создаваемое вручную человеком, для
              которого природа Карелии - это частица души!
            </p>
